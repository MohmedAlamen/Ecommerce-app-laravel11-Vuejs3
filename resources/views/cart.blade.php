...
<div class="row">
    ...
    <h2>YOUR BAG <span class="title_cartpage">{{ Cart::getTotalQuantity() }} ITEMS </span></h2>
        ...
        @foreach(Cart::getcontent() as $item)
            <div class="container cart_item">
                ...
                <p class="cart_p">Color: Black <br>
                    ...
                    <form action="{{route('cart.destroy', $item->model->id)}}" method="POST">
                    {{csrf_field()}}
                    {{method_field('DELETE')}}
                    <button type="submit" class="btn btn-link">Delete</button>
                </form>

                    <form action="{{ route('cart.switchToSaveForLater', ['id' => $item->id]) }}" method="POST">
                        @csrf
        ...
        {{--    -------------- Coupon code end ----------------------- --}}
            ...
            <div class="cart_sidebar">
                ...
                <div class="cart-calculator">
                    <table class="table">
                    <tr>
                        <td>{{ Cart::getTotalQuantity() }} PRODUCTS</td>
                        <td></td>
                    </tr>
                    <tr>
                        <td>Product total</td>
